...
class HBM : public IDRAM, public Implementation
{
  ...
  public:
    ...
    inline static const std::map<std::string, std::vector<int>> timing_presets = {
        ...
        //   nRREFD  tCK_ps
        {"HBM_2Gbps", {2000, 2, 7, 7, 7, 7, 17, 19, 8,   2,    3,  2, 1,
  ...
  public:
    ...
    {
        Node(HBM* dram, Node* parent, int level, int id)
            : DRAMNodeBase<HBM>(dram, parent, level, id){};
    };
...
#undef V
    ...
    void set_preqs()
    {
        ...
        m_preqs[m_levels["channel"]][m_commands["REFab"]] =
            Lambdas::Preq::Channel::RequireAllBanksClosed<HBM>;

        // Bank actions
        m_preqs[m_levels["bank"]][m_commands["REFsb"]] =
            Lambdas::Preq::Bank::RequireBankClosed<HBM>;
