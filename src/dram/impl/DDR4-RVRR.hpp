...
{
    RAMULATOR_REGISTER_IMPLEMENTATION(IDRAM, DDR4RVRR, "DDR4-RVRR",
                                      "DDR4 with Reduced Victim Row Refresh")
  private:
    int m_RH_radius = -1;
  ...
  public:
    ...
    inline static const std::map<std::string, std::vector<int>> timing_presets = {
        //   name       rate   nBL  nCL  nRCD  nRP   nRAS  nRC   nWR  nRTP nCWL nCCDS nCCDL nRRDS
        //   nRRDL nWTRS nWTRL nFAW  nRFC nREFI nVRR nRVRR nCS, tCK_ps
        {"DDR4_1600J",
         {1600, 4, 10, 10, 10, 28, 38, 12, 6, 9, 4, 5, -1, -1, 2, 6, -1, -1, -1, -1, -1, 2, 1250}},
        {"DDR4_1600K",
         {1600, 4, 11, 11, 11, 28, 39, 12, 6, 9, 4, 5, -1, -1, 2, 6, -1, -1, -1, -1, -1, 2, 1250}},
        {"DDR4_1600L",
         {1600, 4, 12, 12, 12, 28, 40, 12, 6, 9, 4, 5, -1, -1, 2, 6, -1, -1, -1, -1, -1, 2, 1250}},
        {"DDR4_1866L",
         {1866, 4, 12, 12, 12, 32, 44, 14, 7, 10, 4, 5, -1, -1, 3, 7, -1, -1, -1, -1, -1, 2, 1071}},
        {"DDR4_1866M",
         {1866, 4, 13, 13, 13, 32, 45, 14, 7, 10, 4, 5, -1, -1, 3, 7, -1, -1, -1, -1, -1, 2, 1071}},
        {"DDR4_1866N",
         {1866, 4, 14, 14, 14, 32, 46, 14, 7, 10, 4, 5, -1, -1, 3, 7, -1, -1, -1, -1, -1, 2, 1071}},
        {"DDR4_2133N",
         {2133, 4, 14, 14, 14, 36, 50, 16, 8, 11, 4, 6, -1, -1, 3, 8, -1, -1, -1, -1, -1, 2, 937}},
        {"DDR4_2133P",
         {2133, 4, 15, 15, 15, 36, 51, 16, 8, 11, 4, 6, -1, -1, 3, 8, -1, -1, -1, -1, -1, 2, 937}},
        {"DDR4_2133R",
         {2133, 4, 16, 16, 16, 36, 52, 16, 8, 11, 4, 6, -1, -1, 3, 8, -1, -1, -1, -1, -1, 2, 937}},
        {"DDR4_2400P",
         {2400, 4, 15, 15, 15, 39, 54, 18, 9, 12, 4, 6, -1, -1, 3, 9, -1, -1, -1, -1, -1, 2, 833}},
        {"DDR4_2400R",
         {2400, 4, 16, 16, 16, 39, 55, 18, 9, 12, 4, 6, -1, -1, 3, 9, -1, -1, -1, -1, -1, 2, 833}},
        {"DDR4_2400U",
         {2400, 4, 17, 17, 17, 39, 56, 18, 9, 12, 4, 6, -1, -1, 3, 9, -1, -1, -1, -1, -1, 2, 833}},
        {"DDR4_2400T",
         {2400, 4, 18, 18, 18, 39, 57, 18, 9, 12, 4, 6, -1, -1, 3, 9, -1, -1, -1, -1, -1, 2, 833}},
        {"DDR4_2666T", {2666, 4,  17, 17, 17, 43, 60, 20, 10, 14, 4,  7,
                        -1,   -1, 4,  10, -1, -1, -1, -1, -1, 2,  750}},
        {"DDR4_2666U", {2666, 4,  18, 18, 18, 43, 61, 20, 10, 14, 4,  7,
                        -1,   -1, 4,  10, -1, -1, -1, -1, -1, 2,  750}},
        {"DDR4_2666V", {2666, 4,  19, 19, 19, 43, 62, 20, 10, 14, 4,  7,
                        -1,   -1, 4,  10, -1, -1, -1, -1, -1, 2,  750}},
        {"DDR4_2666W", {2666, 4,  20, 20, 20, 43, 63, 20, 10, 14, 4,  7,
                        -1,   -1, 4,  10, -1, -1, -1, -1, -1, 2,  750}},
        {"DDR4_2933V", {2933, 4,  19, 19, 19, 47, 66, 22, 11, 16, 4,  8,
                        -1,   -1, 4,  11, -1, -1, -1, -1, -1, 2,  682}},
        {"DDR4_2933W", {2933, 4,  20, 20, 20, 47, 67, 22, 11, 16, 4,  8,
                        -1,   -1, 4,  11, -1, -1, -1, -1, -1, 2,  682}},
        {"DDR4_2933Y", {2933, 4,  21, 21, 21, 47, 68, 22, 11, 16, 4,  8,
                        -1,   -1, 4,  11, -1, -1, -1, -1, -1, 2,  682}},
        {"DDR4_2933AA", {2933, 4,  22, 22, 22, 47, 69, 22, 11, 16, 4,  8,
                         -1,   -1, 4,  11, -1, -1, -1, -1, -1, 2,  682}},
        {"DDR4_3200W", {3200, 4,  20, 20, 20, 52, 72, 24, 12, 16, 4,  8,
                        -1,   -1, 4,  12, -1, -1, -1, -1, -1, 2,  625}},
        {"DDR4_3200AA", {3200, 4,  22, 22, 22, 52, 74, 24, 12, 16, 4,  8,
                         -1,   -1, 4,  12, -1, -1, -1, -1, -1, 2,  625}},
        {"DDR4_3200AC", {3200, 4,  24, 24, 24, 52, 76, 24, 12, 16, 4,  8,
                         -1,   -1, 4,  12, -1, -1, -1, -1, -1, 2,  625}},
    };
    ...
    inline static constexpr ImplDef m_commands = {
        ...
        "WRA",  "REFab",   "REFab_end", "VRR", "VRR_end", // Victim Row Refresh command
    ...
    inline static constexpr ImplDef m_timings = {
        "rate", "nBL",  "nCL",   "nRCD",  "nRP",   "nRAS",  "nRC",   "nWR",
        "nRTP", "nCWL", "nCCDS", "nCCDL", "nRRDS", "nRRDL", "nWTRS", "nWTRL",
        "nFAW", "nRFC", "nREFI", "nVRR",  "nRVRR", "nCS",   "tCK_ps"};
  ...
  public:
    ...
    {
        Node(DDR4RVRR* dram, Node* parent, int level, int id)
            : DRAMNodeBase<DDR4RVRR>(dram, parent, level, id){};
    };
        ...
        if (m_latency_factor_rfc != 1.0f)
            m_timing_vals("nRFC") =
                m_latency_factor_rfc *
                    ((float)m_timing_vals("nRFC") * (float)m_timing_vals("nRAS") /
                     (float)(m_timing_vals("nRAS") + m_timing_vals("nRP"))) +
                ((float)m_timing_vals("nRFC") * (float)m_timing_vals("nRP") /
                 (float)(m_timing_vals("nRAS") + m_timing_vals("nRP")));
...
#undef V
    ...
    void set_actions()
    {
        ...
        m_actions[m_levels["rank"]][m_commands["REFab_end"]] =
            Lambdas::Action::Rank::REFab_end<DDR4RVRR>;
        ...
        m_actions[m_levels["bank"]][m_commands["VRR_end"]] =
            Lambdas::Action::Bank::VRR_end<DDR4RVRR>;
    ...
    void set_preqs()
    {
        ...
        m_preqs[m_levels["rank"]][m_commands["REFab"]] =
            Lambdas::Preq::Rank::RequireAllBanksClosed<DDR4RVRR>;
        ...
        m_preqs[m_levels["bank"]][m_commands["VRR"]] =
            Lambdas::Preq::Bank::RequireBankClosed<DDR4RVRR>;
        m_preqs[m_levels["bank"]][m_commands["RVRR"]] =
            Lambdas::Preq::Bank::RequireBankClosed<DDR4RVRR>;
        m_preqs[m_levels["bank"]][m_commands["ACT"]] =
            Lambdas::Preq::Bank::RequireRowOpen<DDR4RVRR>;
    ...
    void set_powers()
    {
        ...
        m_powers[m_levels["rank"]][m_commands["REFab_end"]] =
            Lambdas::Power::Rank::REFab_end<DDR4RVRR>;
        ...
        m_powers[m_levels["rank"]][m_commands["RVRR_end"]] =
            Lambdas::Power::Rank::VRR_end<DDR4RVRR>;
    ...
    void process_rank_energy(PowerStats& rank_stats, Node* rank_node)
    {
        ...
        double ref_cmd_energy = (VE("VDD") * (CE("IDD5B")) + VE("VPP") * (CE("IPP5B"))) *
                                rank_stats.cmd_counters[m_cmds_counted("REF")] * TS("nRFC") *
                                tCK_ns / 1E3;
        ...
        rank_stats.total_cmd_energy = act_cmd_energy + pre_cmd_energy + rd_cmd_energy +
                                      wr_cmd_energy + ref_cmd_energy + vrr_cmd_energy +
                                      rvrr_cmd_energy;
