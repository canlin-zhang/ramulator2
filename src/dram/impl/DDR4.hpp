...
namespace Ramulator
{
  ...
  public:
    ...
    inline static const ImplLUT m_request_translations = LUT(
        m_requests, m_commands, {{"read", "RD"}, {"write", "WR"}, {"all-bank-refresh", "REFab"}, {"open-row", "ACT"}, {"close-row", "PRE"}});
...
#undef V
    ...
    void process_rank_energy(PowerStats &rank_stats, Node *rank_node)
    {
      ...
      rank_stats.total_cmd_energy = act_cmd_energy + pre_cmd_energy + rd_cmd_energy + wr_cmd_energy + ref_cmd_energy;
