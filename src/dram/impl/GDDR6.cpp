...
class GDDR6 : public IDRAM, public Implementation
{
  ...
  public:
    ...
    inline static const std::map<std::string, std::vector<int>> timing_presets = {
        //       name                rate   nBL  nCL  nRCDRD nRCDWD  nRP   nRAS  nRC   nWR  nRTP
        //       nCWL nCCDS nCCDL nRRDS nRRDL nWTRS nWTRL nFAW  nRFC nRFCpb nRREFD nREFI  tCK_ps
        {"GDDR6_2000_1350mV_double", {2000, 8, 24, 26, 16, 26, 53,  79,  26, 4,    6,  4,
                                      6,    7, 7,  9,  11, 28, 210, 105, 14, 3333, 570}},
        {"GDDR6_2000_1250mV_double", {2000, 8,  24, 30, 19, 30, 60,  89,  30, 4,    6,  4,
                                      6,    11, 11, 9,  11, 42, 210, 105, 21, 3333, 570}},
        {"GDDR6_2000_1350mV_quad", {2000, 4, 24, 26, 16, 26, 53,  79,  26, 4,    6,  4,
                                    6,    7, 7,  9,  11, 28, 210, 105, 14, 3333, 570}},
        {"GDDR6_2000_1250mV_quad", {2000, 4,  24, 30, 19, 30, 60,  89,  30, 4,    6,  4,
                                    6,    11, 11, 9,  11, 42, 210, 105, 21, 3333, 570}},
    };
    ...
    inline static constexpr ImplDef m_commands = {
        // figure 3
        "ACT", "PREA", "PRE", "RD", "WR", "RDA", "WRA", "REFab", "REFpb", "REFp2b",
    };
    ...
    inline static constexpr ImplDef m_timings = {
        "rate",  "nBL",  "nCL",  "nRCDRD", "nRCDWD", "nRP",    "nRAS",  "nRC",
        "nWR",   "nRTP", "nCWL", "nCCDS",  "nCCDL",  "nRRDS",  "nRRDL", "nWTRS",
        "nWTRL", "nFAW", "nRFC", "nREFI",  "nRREFD", "nRFCpb", "tCK_ps"};
  ...
  public:
    ...
    {
        Node(GDDR6* dram, Node* parent, int level, int id)
            : DRAMNodeBase<GDDR6>(dram, parent, level, id){};
    };
        ...
        populate_timingcons(
            this,
            {
                ...
                {.level = "channel",
                 .preceding = {"RD", "RDA"},
                 .following = {"WR", "WRA"},
                 .latency = V("nCL") + V("nBL") + 3 - V("nCWL") +
                            1}, //+ 1 is assuming bus turn around time
...
#undef V
    ...
    void set_preqs()
    {
        ...
        m_preqs[m_levels["channel"]][m_commands["REFab"]] =
            Lambdas::Preq::Channel::RequireAllBanksClosed<GDDR6>;
        ...
        // m_preqs[m_levels["channel"]][m_commands["REFpb"]] =
        // Lambdas::Preq::Bank::RequireAllBanksClosed<GDDR6>; // can RequireSameBanksClosed be used,
        // or is RequireBankClosed needed? m_preqs[m_levels["channel"]][m_commands["REFp2b"]] =
        // Lambdas::Preq::Bank::RequireAllBanksClosed<GDDR6>;
    };
