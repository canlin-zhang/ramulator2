...
class IFrontEnd : public Clocked<IFrontEnd>, public TopLevel<IFrontEnd>
{
  ...
  public:
    ...
    /**
     * @brief    Receives memory requests from external sources (e.g., coming from a full system
     * simulator like GEM5)
     *
     * @details
     * This functions should take memory requests from external sources (e.g., coming from GEM5),
     * generate Ramulator 2 Requests, (tries to) send to the memory system, and return if this is
     * successful
     *
     */
