...
namespace Ramulator
{
  ...
  public:
    ...
    inline static const ImplLUT m_request_translations = LUT(
        m_requests, m_commands, {{"read", "RD"}, {"write", "WR"}, {"all-bank-refresh", "REFab"}, {"victim-row-refresh", "VRR"}, {"reduced-victim-row-refresh", "RVRR"}, {"open-row", "ACT"}, {"close-row", "PRE"}});
  ...
  private:
    ...
    void set_timing_vals()
    {
      ...
      if (m_latency_factor_rfc != 1.0f)
        m_timing_vals("nRFC") = m_latency_factor_rfc * ((float)m_timing_vals("nRFC") * (float)m_timing_vals("nRAS") / (float)(m_timing_vals("nRAS") + m_timing_vals("nRP"))) + ((float)m_timing_vals("nRFC") * (float)m_timing_vals("nRP") / (float)(m_timing_vals("nRAS") + m_timing_vals("nRP")));
...
#undef V
    ...
    void process_rank_energy(PowerStats &rank_stats, Node *rank_node)
    {
      ...
      double ref_cmd_energy = (VE("VDD") * (CE("IDD5B")) + VE("VPP") * (CE("IPP5B"))) * rank_stats.cmd_counters[m_cmds_counted("REF")] * TS("nRFC") * tCK_ns / 1E3;
      ...
      rank_stats.total_cmd_energy = act_cmd_energy + pre_cmd_energy + rd_cmd_energy + wr_cmd_energy + ref_cmd_energy + vrr_cmd_energy + rvrr_cmd_energy;
