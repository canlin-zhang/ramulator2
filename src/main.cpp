...
int main(int argc, char* argv[])
{
    ...
    program.add_argument("-p", "--param")
        .metavar("KEY=VALUE")
        .append()
        .help("Specify parameter to override in the configuration file. Repeat this option to "
    ...
    // Instaniate the frontend of the simulated system, this is one of the top-level objects in
    // Ramulator 2.0. It also recursively instaniate all components in the frontend.
    auto frontend = Ramulator::Factory::create_frontend(config);
    // Instaniate the memory system of the simulated system, this is one of the top-level objects in
    // Ramulator 2.0 It also recursively instaniate all components in the memory system.
