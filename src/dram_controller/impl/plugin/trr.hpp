...
{
    RAMULATOR_REGISTER_IMPLEMENTATION(IControllerPlugin, CounterBasedTRR, "CounterBasedTRR",
                                      "CounterBasedTRR.")
  private:
    Clk_t m_clk = 0;
    IDeviceSpec* m_spec;
  ...
  public:
    void init() override
    {
        ...
        m_size = param<int>("table_size")
                     .desc("Number of entries per bank-level TRR table")
                     .default_val(16);
    };
    ...
    void setup(IFrontEnd* frontend, IMemorySystem* memory_system) override
    {
        ...
        m_num_banks = (m_bankgroup_level_idx == -1)
                          ...
                          : m_spec->organization.count[m_bankgroup_level_idx] *
                                m_spec->organization.count[m_bank_level_idx];
        ...
        if (request_found)
        {
            ...
            if (req_it->command == m_ACT_id)
            {
                ...
                else
                {
                    ...
                    bank_id = bank_groupid * m_num_banks_per_bankgroup +
                              req_it->addr_vec[m_bank_level_idx];
                }
