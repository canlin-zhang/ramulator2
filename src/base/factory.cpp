...
bool Factory::register_implementation(std::string ifce_name, std::string impl_name,
                                      std::string impl_desc, const Constructor_t& cstr)
{
    DEBUG_LOG(DFACTORY, Logging::get("Base"), "Registering implementation {} to interface {}...",
              impl_name, ifce_name)
...
Implementation* Factory::create_implementation(std::string ifce_name, std::string impl_name,
                                               const YAML::Node& config, Implementation* parent)
{
    DEBUG_LOG(DFACTORY, Logging::get("Base"), "Creating implementation {} of interface {}...",
              impl_name, ifce_name)
...
Implementation* Factory::create_implementation(std::string ifce_name, const YAML::Node& config,
                                               Implementation* parent)
{
    DEBUG_LOG(DFACTORY, Logging::get("Base"), "Creating an implementation of interface {}...",
              ifce_name)
...
{
    Implementation* impl =
        Factory::create_implementation(IMemorySystem::get_name(), config, nullptr);
