...
class LinearMapperBase : public IAddrMapper
{
  ...
  protected:
    void setup(IFrontEnd* frontend, IMemorySystem* memory_system)
    {
        ...
        // Populate m_addr_bits vector with the number of address bits for each level in the
        // hierachy
...
{
    RAMULATOR_REGISTER_IMPLEMENTATION(IAddrMapper, RoBaRaCoCh, "RoBaRaCoCh",
...
{
    RAMULATOR_REGISTER_IMPLEMENTATION(IAddrMapper, MOP4CLXOR, "MOP4CLXOR",
