...
namespace Ramulator
{
  ...
  public:
    ...
    void setup(IFrontEnd *frontend, IMemorySystem *memory_system) override
    {
      ...
      m_num_banks = (m_bankgroup_level_idx == -1) ? m_spec->organization.count[m_bank_level_idx] : m_spec->organization.count[m_bankgroup_level_idx] * m_spec->organization.count[m_bank_level_idx];
