...
SimpleO3LLC::SimpleO3LLC(int latency, int size_bytes, int linesize_bytes, int associativity,
                         int num_mshrs)
...
void SimpleO3LLC::evict_line(CacheSet_t& set, CacheSet_t::iterator victim_it)
{
    ...
    if (victim_it->dirty)
    {
        ...
        DEBUG_LOG(DSIMPLEO3LLC, m_logger, "Writeback Request will be issued at Clk={}.",
                  m_clk + m_latency);
    }
