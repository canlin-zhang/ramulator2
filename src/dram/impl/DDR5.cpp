...
class DDR5 : public IDRAM, public Implementation
{
  ...
  public:
    ...
    inline static const std::map<std::string, std::vector<int>> timing_presets = {
        ...
        //   nREFSBRD nRFM1 nRFM2 nRFMsb nDRFMab nDRFMsb nCS, tCK_ps
        {"DDR5_3200AN",
         {3200,        8, 24, 24, 24, 52, 75, 48, 12, 22, 2,  8,  8,  22 + 8 + 4, 8, 16,
          22 + 8 + 16, 8, -1, -1, -1, -1, -1, -1, 30, -1, -1, -1, -1, -1,         2, 625}},
        {"DDR5_3200BN",
         {3200,        8, 26, 26, 26, 52, 77, 48, 12, 24, 2,  8,  8,  24 + 8 + 4, 8, 16,
          24 + 8 + 16, 8, -1, -1, -1, -1, -1, -1, 30, -1, -1, -1, -1, -1,         2, 625}},
        {"DDR5_3200C",
         {3200,        8, 28, 28, 28, 52, 79, 48, 12, 26, 2,  8,  8,  26 + 8 + 4, 8, 16,
          26 + 8 + 16, 8, -1, -1, -1, -1, -1, -1, 30, -1, -1, -1, -1, -1,         2, 625}},
    };
    ...
    inline static constexpr ImplDef m_commands = {
        ...
        "RFMab_end", "RFMsb_end", "DRFMab", "DRFMsb",    "DRFMab_end", "DRFMsb_end",
    };
    ...
    inline static constexpr ImplDef m_requests = {
        "read",     "write",         "all-bank-refresh", "same-bank-refresh",
        "rfm",      "same-bank-rfm", "directed-rfm",     "same-bank-directed-rfm",
        "open-row", "close-row"};
    ...
    inline static constexpr ImplDef m_timings = {
        ...
        "nRTP",      "nCWL",  "nPPD",  "nCCDS",  "nCCDS_WR", "nCCDS_WTR", "nCCDL",  "nCCDL_WR",
        "nCCDL_WTR", "nRRDS", "nRRDL", "nFAW",   "nRFC1",    "nRFC2",     "nRFCsb", "nREFI",
        "nREFSBRD",  "nRFM1", "nRFM2", "nRFMsb", "nDRFMab",  "nDRFMsb",   "nCS",    "tCK_ps"};
    ...
    inline static constexpr ImplDef m_cmds_counted = {"ACT", "PRE", "RD", "WR", "REF", "RFM"};
  ...
  public:
    ...
    {
        Node(DDR5* dram, Node* parent, int level, int id)
            : DRAMNodeBase<DDR5>(dram, parent, level, id){};
    };
...
#define V(timing) (m_timing_vals(timing))
        ...
        populate_timingcons(
            this,
            {
                ...
                {.level = "rank",
                 .preceding = {"REFab"},
                 .following = {"ACT", "PREA", "REFab", "RFMab", "DRFMab", "REFsb", "RFMsb",
                               "DRFMsb"},
                 .latency = V("nRFC1")},
                {.level = "rank",
                 .preceding = {"RFMab"},
                ...
                {.level = "bank",
                 .preceding = {"ACT"},
                 .following = {"ACT", "REFsb", "RFMsb", "DRFMsb"},
                 .latency = V("nRC")},
                {.level = "bank",
                 .preceding = {"ACT"},
                 .following = {"RD", "RDA", "WR", "WRA"},
...
#undef V
    ...
    void set_actions()
    {
        ...
        m_actions[m_levels["rank"]][m_commands["REFab_end"]] =
            Lambdas::Action::Rank::REFab_end<DDR5>;
    ...
    void set_preqs()
    {
        ...
        m_preqs[m_levels["rank"]][m_commands["REFab"]] =
            Lambdas::Preq::Rank::RequireAllBanksClosed<DDR5>;
        ...
        m_preqs[m_levels["rank"]][m_commands["REFsb"]] =
            Lambdas::Preq::Rank::RequireSameBanksClosed<DDR5>;
    ...
    void set_powers()
    {
        ...
        // Lambdas::Power::Rank::REFsb_end<DDR5>;
        ...
        // Lambdas::Power::Rank::REFab_end<DDR5>; m_powers[m_levels["rank"]][m_commands["DRFMab"]] =
        // Lambdas::Power::Rank::REFab<DDR5>; m_powers[m_levels["rank"]][m_commands["DRFMab_end"]] =
        // Lambdas::Power::Rank::REFab_end<DDR5>;
