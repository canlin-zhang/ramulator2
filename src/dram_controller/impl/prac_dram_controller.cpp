#include "prac_dram_controller.h"
...
bool PRACDRAMController::send(Request& req)
{
...
bool PRACDRAMController::priority_send(Request& req)
{
    req.final_command = m_dram->m_request_translations(req.type_id);
...
void PRACDRAMController::serve_completed_reads()
{
    if (pending.size())
    {
